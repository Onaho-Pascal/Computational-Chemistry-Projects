...
# print(f"✅ Canonical SMILES: {QUERY_SMILES}")
...
# CONFIGURATION
# ===============================
sdf_file = "FK506_tacro_6536850 (3).sdf"
IMAGE_DIR = "compound_images"
OUT_FILE = "multi_db_results_full.csv"
os.makedirs(IMAGE_DIR, exist_ok=True)
...
print(f"✅ {len(chembl_df)} hits from ChEMBL.")
...
print(f"✅ {len(pubchem_df)} hits from PubChem.")
...
try:
    ...
    print(f"⚠️ ZINC search failed: {e}")
print(f"✅ {len(zinc_df)} hits from ZINC.")


# ==================================================
# 4️⃣ BindingDB SEARCH
# ==================================================
print("\n🧬 Searching BindingDB...")
...
try:
    ...
    print(f"⚠️ BindingDB search failed: {e}")
print(f"✅ {len(bindingdb_df)} hits from BindingDB.")


# ==================================================
# 5️⃣ DrugCentral SEARCH
# ==================================================
print("\n💊 Searching DrugCentral...")
...
try:
    ...
    print(f"⚠️ DrugCentral search failed: {e}")
print(f"✅ {len(drugcentral_df)} hits from DrugCentral.")


# ==================================================
# 6️⃣ PDB Ligand Search
# ==================================================
print("\n🧩 Searching RCSB PDB...")
pdb_df = pd.DataFrame()
try:
    ...
    print(f"⚠️ PDB search failed: {e}")
print(f"✅ {len(pdb_df)} hits from PDB.")
...
try:
    ...
    print(f"⚠️ KEGG search failed: {e}")
print(f"✅ {len(kegg_df)} hits from KEGG.")


# ==================================================
# 8️⃣ NPASS Natural Products
# ==================================================
print("\n🌿 Searching NPASS...")
...
try:
    ...
    print(f"⚠️ NPASS search failed: {e}")
print(f"✅ {len(npass_df)} hits from NPASS.")


# ==================================================
# 9️⃣ COCONUT Natural Products
# ==================================================
print("\n🥥 Searching COCONUT...")
...
try:
    ...
    print(f"⚠️ COCONUT search failed: {e}")
print(f"✅ {len(coconut_df)} hits from COCONUT.")
...
print(f"\n📊 Combined total: {len(all_results)} compounds from all databases.")
all_results.to_csv(OUT_FILE, index=False)
print(f"💾 Results saved to: {OUT_FILE}")

print("\n✅ Multi-database compound search complete.")
